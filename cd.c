...
/**
 * __cd_error - printing the error upon failure to change directory
 * @info: shell info
 * @dir: directory to canghange it.
 * Return:no thing.
 */
...
/**
 * __cd_success - update the environment if successed.
 * @info: shell info
 * Return:no thing.
 */
...
/**
 * __cd - changeing the directory
 * @info: arguments is passed
 *
 * Return: int of the cd.
 */
